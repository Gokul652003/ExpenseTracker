...
import { signInWithGoogle, signInWithNotion } from '../supabase/supabaseApis';
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button className="block bg-primary px-10 py-3 rounded-full text-textColor font-primary">
                Create Account
              </button>
